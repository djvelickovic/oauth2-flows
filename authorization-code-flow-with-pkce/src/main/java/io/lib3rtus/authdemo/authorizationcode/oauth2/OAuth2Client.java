package io.lib3rtus.authdemo.authorizationcode.oauth2;
...
public class OAuth2Client {
    ...
    public String getAuthorizationEndpointWithChallenge(String state) {
//        "/realms/OAuth2FlowsTest/protocol/openid-connect/auth?response_type=code&redirect_uri=http://localhost:8280/auth&client_id=authorization-code-flow-demo&state=1234";
        ...
        return String.format(authorizationEndpoint+"?response_type=%s&redirect_uri=%s&client_id=%s&state=%s&code_challenge=%s&code_challenge_method=%s", "code", redirectUri, clientId, state, "");
    }
